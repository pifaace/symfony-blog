 ...
 */
final class Version20181224152453 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE author_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE user_id author_id INT NOT NULL');
